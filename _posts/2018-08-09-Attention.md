...
## 实现
### Tensorflow
Tensorflow中有很好的attention decoder实现[tf.contrib.legacy_seq2seq.attention_decoder](https://www.tensorflow.org/api_docs/python/tf/contrib/legacy_seq2seq/attention_decoder)，为方便可视化，在此基础上添加了attention位置的输出。
